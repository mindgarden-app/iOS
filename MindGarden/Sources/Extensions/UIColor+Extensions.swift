...
extension UIColor {
    ...
    @nonobjc class var GrayForFont: UIColor {
    ...
    @nonobjc class var lightGreen: UIColor {
        return UIColor(red: 120.0 / 255.0, green: 222.0 / 255.0, blue: 176.0 / 255.0, alpha: 1.0)
    }
    ...
    @nonobjc class var grayForBorder: UIColor {
